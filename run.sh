...
sudo perf stat -o ../cpu-cycles/cpu-cycles-0.txt -e cpu-cycles sudo ./Pool-HashJoin-PCM --id=0 --r-size=20000000 --s-size=20000000 --total-cores=4 --monitor-cores=4 --task-size=1000000 --hj-threads=0 --share-hash-table=0 --skew=0 --core-pausing=0 --program-pmu=1
